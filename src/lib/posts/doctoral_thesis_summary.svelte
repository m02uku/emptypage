...
<section>
	...
	<p>
		...
		bridging symbolic linguistic theory and neural representation learning through multi-dimensional
	...
	<div>
		...
		<p>
			<em>
				What are the optimal representational units for language modeling in the deep learning era,
				considering predictive accuracy, linguistic interpretability, cognitive plausibility, and
	...
	<table>
		...
		<tbody>
			...
			<tr>
				<td>RQ2</td>
				<td>
					Can we design architectures that integrate symbolic knowledge with neural representations?
				</td>
